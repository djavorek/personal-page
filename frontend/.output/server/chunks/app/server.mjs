import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, unref, inject as inject$1, defineAsyncComponent, createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, toRef, watchEffect, provide, onScopeDispose, withDirectives, vShow, Fragment, resolveDirective, reactive, onUnmounted, createTextVNode, capitalize, h, defineComponent as defineComponent$1, shallowReactive, Suspense, camelize, toRaw, readonly, TransitionGroup, isRef, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, withModifiers, toDisplayString, vModelText, useSSRContext, createApp, isVNode, Comment, isReactive, onErrorCaptured, onServerPrefetch, isReadonly, getCurrentScope, markRaw, isShallow, withCtx } from 'vue';
...
const _routes = [
  {
    ...
    children: [
      {
        name: "blog-categories-category",
        path: ":category()",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/_category_-18c829bc.mjs').then((m) => m.default || m)
      }
    ],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/categories-367eb1ef.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.name) ?? "blog-impressum",
    path: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) ?? "/blog/impressum",
    url: "/blog/impressum",
    meta: __nuxt_page_meta$2 || {},
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./_nuxt/impressum-3c38718c.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-331ee109.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "blog-posts-post",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/blog/posts/:post()",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/_post_-28997adf.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-fd44a449.mjs').then((m) => m.default || m)
  }
];
...
const plugin_RhysaxXBRT = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(Vue3Disqus);
  return {
    provide: {
      disqusOptions: (/* @__PURE__ */ useRuntimeConfig()).public.disqus
    }
  };
});
const isVue2 = false;
...
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-a89e14bf.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-5c290816.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-0b8fdf39.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-fba1175f.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-4ffc20d5.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-08061214.mjs').then((r) => r.default));
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./_nuxt/ProseCodeInline-545a3c4a.mjs').then((r) => r.default));
const LazyProsePre = defineAsyncComponent(() => import('./_nuxt/ProsePre-b1575e13.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-911986ba.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-067e3509.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./_nuxt/ProseEm-fc682122.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-cdb3350d.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-e01f0fb6.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-96988674.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-ed25f66e.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-66b2e62b.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-40ade86a.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-528a5c16.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-a43fda09.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./_nuxt/ProseLi-3c7e0e56.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./_nuxt/ProseOl-209246fb.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./_nuxt/ProseP-6677e8e8.mjs').then((r) => r.default));
const LazyProseScript = defineAsyncComponent(() => import('./_nuxt/ProseScript-bfe5d4dd.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./_nuxt/ProseStrong-8c660fd2.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./_nuxt/ProseTable-d19a61cb.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./_nuxt/ProseTbody-abf226ce.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./_nuxt/ProseTd-b653191b.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./_nuxt/ProseTh-c916b083.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./_nuxt/ProseThead-81b2ad98.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./_nuxt/ProseTr-41cbddb8.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./_nuxt/ProseUl-5c3d500f.mjs').then((r) => r.default));
...
const dom_handlers_CkRRkVoWsl = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  return {
    provide: {
      resizeHandler: (store) => {
      ...
      addObserverIfNavBarAvailable: (mutObserver) => {
        ...
        if (!node) {
          window.setTimeout(globalThis.addObserverIfNavBarAvailable, 400);
          return;
        }
        const mutOptions = {
          attributes: true,
...
const useBlogStore = defineStore("blogStore", {
  ...
  actions: {
    async init() {
      const blogPosts = await this.$content("posts").where({ draft: false }).sortBy("createdAt", "desc").fetch().catch((e) => {
...
const init_blog_server_HbpBbH0W6c = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
  const blog = useBlogStore(nuxtApp.$pinia);
  [__temp, __restore] = executeAsync(() => blog.init()), await __temp, __restore();
});
const moment = require("moment");
require("moment/locale/hu");
const moment_lgOtqBZZj3 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(require("vue-moment"), { moment });
});
const toCurrency_y5r9Dx8HuJ = () => {
};
const en = {
  badge: "Badge",
  open: "Open",
...
const plugins = [
  ...
  dom_handlers_CkRRkVoWsl,
  fontawesome_klhsrycjcK,
  init_blog_server_HbpBbH0W6c,
  moment_lgOtqBZZj3,
  toCurrency_y5r9Dx8HuJ,
  vuetify_8NhHJigKc1
];
const layouts = {
  blog: () => import('./_nuxt/blog-c9796d76.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-655040bf.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-18780afc.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-08524e29.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, createError as c, useRoute$1 as d, entry$1 as default, asyncDataDefaults as e, useNuxtApp as f, injectHead as i, mapState as m, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter$1 as u };
