...
import { e as asyncDataDefaults, f as useNuxtApp, c as createError, a as useRuntimeConfig } from '../server.mjs';
import { x as withLeadingSlash, j as joinURL, t as withoutTrailingSlash, y as withBase, v as hash } from '../../nitro/node-server.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-7b789977.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-5c62bd07.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-0ccead5f.mjs.map
