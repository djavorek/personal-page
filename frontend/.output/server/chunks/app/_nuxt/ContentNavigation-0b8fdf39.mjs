import { u as useContentDisabled, a as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-0ccead5f.mjs';
import { v as hash } from '../../nitro/node-server.mjs';
import { f as useNuxtApp, a as useRuntimeConfig } from '../server.mjs';
import { defineComponent, toRefs, computed, useSlots, useSSRContext, toRef, isRef, h } from 'vue';
import { u as useContentPreview } from './preview-7b789977.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-5c62bd07.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-0b8fdf39.mjs.map
